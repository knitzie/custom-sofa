...
angular.module('customSofaApp')
        ...
        .factory('navigationService', ['$location', 'trackingService', 'urlConstructionService',
            function($location, trackingService, urlConstructionService) {
                var self = {};
                ...
                // createUrlForCheckout() returns '/checkout'
